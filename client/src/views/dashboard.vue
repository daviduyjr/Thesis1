      ...
      <div class="col-md-12">
        <div class="page-header-toolbar">
          ...
          <div class="sort-wrapper">
            <button type="button" class="btn btn-primary toolbar-item">
              New
            </button>
            <b-dropdown
              class="ml-auto"
            ...
            <div class="d-flex flex-column flex-lg-row">
              ...
              <div class="ml-lg-auto" id="sales-statistics-legend">
                <div class="chartjs-legend">
                  <ul>
                    <li>
                      <span style="background-color: #8862e0"></span>Revenue
                    </li>
                    <li>
                      <span style="background-color: #19d895"></span>Sales
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="mb-4" id="net-profit-legend">
                <div class="chartjs-legend">
                  <ul>
                    <li>
                      <span
                        style="background-color:rgba(88, 208, 222,0.8)"
                      ></span
                      >Sales
                    </li>
                    <li>
                      <span style="background-color:rgba(150, 77, 247,1)"></span
                      >Orders
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dateSorter">
                      <div class="dropdown-item" id="market-overview_1">
                        Daily
                      </div>
                      <div class="dropdown-item" id="market-overview_2">
                        Weekly
                      </div>
                      <div class="dropdown-item" id="market-overview_3">
                        Monthly
                      </div>
                    </div>
                  </div>
