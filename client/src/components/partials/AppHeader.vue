<template>
  <b-navbar
    id="template-header"
    class="navbar default-layout col-lg-12 col-12 p-0 fixed-top"
    toggleable="md"
  >
    <div
    ...
    >
      <router-link class="navbar-brand brand-logo" to="/">
        ...
        <h2 class="companyName">GENERICA</h2>
      </router-link>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-center ml-auto ml-lg-0">
      ...
      <b-navbar-nav class="navbar-nav ml-auto">
        <b-nav-item
          class="font-weight-semibold d-none d-lg-block"
          href="#"
          v-if="!isLoggedIn"
          to="/pages/login"
          >LogIn</b-nav-item
        >
        <b-nav-item
          class="font-weight-semibold d-none d-lg-block mr-sm-2"
          href="#"
          v-if="isLoggedIn"
